				  ...
				  <div class="row">
					...
					<div class="col-lg-10 col-sm-10 col-md-10 col-xs-10">
						 <div class="caption">
							...
							<h6 >
								<span style="font-weight:Bold; font-size:11px;">Rate </span><span style="margin-left:41px;">
							...
							<h6 >
								<span style="font-weight:Bold; font-size:11px;">Price &nbsp;</span><span style="margin-left:33px;">
