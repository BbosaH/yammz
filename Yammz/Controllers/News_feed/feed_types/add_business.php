	...
	.event_title_name{
		...
		<div class="row">
			...
			<div class="col-md-10 col-lg-10 col-sm-10 col-xl-10 col-xs-10 profile_name_section_left">
				...
				<h6 style="margin-top: 3px;margin-bottom: 20px;">					
					<span class="profile_name" style="padding-left:1px;">
					...
					<label class="help-block " style="color:#CFCFCF;margin-top: 3px;padding-left:1px;">{{feed.date_created}} </label>
				</h6>
			</div>
		</div>
			...
			<div class="col-md-12 col-lg-12 col-sm-12 col-xl-12 col-xs-12 ">
				 ...
				 <img ng-if="feed.business_photo.length>0" ng-src="{{feed.business_photo}}" class="img-responsive"  style="width:440px;height:250px"  alt="Generic placeholder thumbnail">

				 <img ng-if="feed.business_photo.length==0" ng-src="{{BaseImageURL}}/uploads/defbanner.png" class="img-responsive"  style="width:440px;height:250px"  alt="Generic placeholder thumbnail">
				 <p style="margin-top:10px;font-weight:bold;margin-bottom: -2px;">

					<a href="business_page_3.php?current_business_id={{feed.business_id}}" ng-show="feed.business_owner_id!=feed.user_id" class="redbright" style="margin-bottom:1px;margin-top:10px;">{{feed.business_name}}</a>

					<a href="business_page_owners_view.php?current_business_id={{feed.business_id}}" ng-show="feed.business_owner_id==feed.user_id" class="redbright" style="margin-bottom:1px;margin-top:10px;">{{feed.business_name}}</a>
				</p>
				
				<div class="profile_updte_time" style="margin-top:5px; margin-bottom:5px;">{{feed.business_address}}</div>
								
								<table>
								<tr>
									<td style="width:500px;">
									<div style="padding-left:0px;margin-top:0px;" ng-show="feed.rate>-1 && feed.price>-1 ">

									<span> 
											<span>
											<i ng-repeat="star in feed.ratings" class="ion ion-ios-star redbright" style="font-size:25px;"></i>
											</span>

											<span style="margin-left:-4px;">
										
											<i ng-repeat="star in feed.noratings" class="ion ion-ios-star-outline redbright" style="font-size:25px;"></i>
											</span>
									...
									<span> 
											...
											<span>
											<i ng-repeat="star in feed.pricings" class="ion ion-social-usd " style="color:#00cc00;padding-left:5px; font-size:20px;"></i>
											</span>
											
											<span style="margin-left:-4px;">
											
											<i ng-repeat="usd in feed.nopricings" class="ion ion-social-usd-outline " style="color:#00cc00; padding-left:5px; font-size:20px;" ></i>
											</span>
								...
								<!-- <div style="padding-left:0px;margin-top:0px;" ng-show="feed.rate==-1 && feed.price==-1 ">
										<span> 
											...
											<i ng-repeat="star in [1,2,3,4,5]" class="ion ion-ios-star-outline redbright" style="font-size:25px;"></i>
											
										</span>
										&nbsp;&nbsp;
										<span> 
												<i ng-repeat="usd in [1,2,3,4,5]" class="ion ion-social-usd-outline " style="color:#00cc00; padding-left:5px; font-size:20px;" ></i>
					...
					<td>	
							...
							<input type="hidden" ng-model="toggle" ng-init="toggle=0" >	
							...
							<div ng-show="feed.business_followed_by_me==1" ng-click="unfollowItem('business',sender_id,feed.business_id,feed.id)" >
								<div class="ion ion-android-checkmark-circle" style="color:#BD2532;font-size:20px; font-weight:bold; margin-top:-15px;margin-left:5px;" ></div>
					...
					<tr>
						...
						<td colspan="" style="padding-left:8px;" >
							...
							<h6 >
								...
								<div id="abcommentors{{feed.id}}" style="margin-bottom:-15px;">
								...
								<hr style="margin-bottom:4px;margin-top:30px;margin-left:-4px;width:109%"></hr>															
								<table>
									<tr>
