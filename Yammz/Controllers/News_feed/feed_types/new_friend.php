...
<style type="text/css">
	...
	<div class="panel-body">
		...
		<div class="row" >
			<!-- column with avatar -->
			<div class="col-md-2 col-lg-2 col-sm-2 col-xl-2 col-xs-2 " style="margin-top:-25px; margin-left:-15px;">
			...
			<div class="col-md-10 col-lg-10 col-sm-10 col-xl-10 col-xs-10 profile_name_section_left" style="margin-top:-25px; margin-left:-15px;">
				...
				<h6 style="margin-top:4px;">					
					...
					<a ng-href="{{BaseURL}}/user_profile.php?id={{feed.user_id}}" style="text-decoration:none;color:#000000">{{feed.user_name}}
					</a>
					 <span style="font-weight:lighter">and</span>&nbsp;
					 <a ng-href="{{BaseURL}}/user_profile_3.php?id={{feed.friend.id}}" style="text-decoration:none;color:#000000">{{feed.friend.first_name}} {{feed.friend.last_name}}</a>
					  <span style="font-weight:lighter;">are now Friends</span></span><br/>
		...
		<div class="row">
			...
			<img ng-src="{{BaseImageURL}}uploads/New_friends_icon.png" style="width:170px;height:120px;">
			</div>
			<div class="col-md-3 col-lg-3 col-sm-3 col-xl-3 col-xs-3">	
		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12 col-xl-12 col-xs-12">	
				<hr class="horizontal_line" ng-show="feed.comments.length>0"></hr>
							<div id="nfcommentors{{feed.id}}" style="margin-bottom:-15px;">
