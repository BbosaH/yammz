		...
		<div class="row">
						...
						<div class="col-md-2 col-lg-2 col-sm-2 col-xl-2 col-xs-2">
							<div class="badge right_most_top_Outer_badge" >
								 <div class="icon icon-add182 " style="font-size:20px;margin-top:85%;"></div> 
							</div>
						</div>
					</div>
		...
		<div class="row" style="margin-bottom:10px;">
			...
			<div class="col-md-9 col-lg-9 col-sm-9 col-xl-9 col-xs-9 profile_name_section_left">
				...
				<h6 style="margin-top:0px;">					
					<span class="profile_name" style="line-height: 20px;" >
			...
			<div class="col-md-12 col-lg-12 col-sm-12 col-xl-12 col-xs-12 ">
				 ...
				 <img ng-src="{{feed.business_photo}}" class="img-responsive"  style="width:440px;height:250px"  alt="Yammzit photo">
				...
				<div class="profile_updte_time" style="margin-top:-5px; margin-bottom:10px;">{{feed.business_address}}</div>
								...
								<tr>
									<td style="width:500px;">
									 <div style="padding-left:0px;margin-top:-5px;" ng-show="feed.rate>-1 && feed.price>-1 ">
					...
					<td>	
							...
							<div ng-show="feed.business_followed_by_me==1" ng-click="unfollowItem('business',sender_id,feed.business_id,feed.id)" >
								<div class="ion ion-android-checkmark-circle" style="color:#BD2532;font-size:20px;margin-top:-15px;" ></div>
								<div style="font-size:10px;margin-left:-11px;color:#C4C4C4;margin-top:4px;">following</div>
							</div>
					</td>
					</tr>
					...
					<tr>
						...
						<td colspan="" style="padding-left:8px;" >
							...
							<h6 >
								...
								<div id="fbcommentors{{feed.id}}" style="margin-bottom:-15px;">
