															...
															<tr style="">
																...
																<td style="vertical-align:top;">
																	...
																	<span>																									
																		...
																		<span style="font-size:11; visibility :visible; " id="likecard{{comment.id}}"  ><span  class="icon icon-like85 " ng-click="likeItem(user_id,comment.id,feed.id)"></span>
																		<span>&nbsp;&nbsp;{{comment.like_number}} likes</span>
