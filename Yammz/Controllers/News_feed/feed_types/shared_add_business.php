	...
	<div class="panel-body">
			...
			<div class="col-md-10 col-lg-10 col-sm-10 col-xl-10 col-xs-10 profile_name_section_left" style="margin-top:-30px;">
				...
				<h6 style="padding-left:6px;">					
					...
					<B>
										...
										<a style="text-decoration:none;" ng-show="feed.inner_feed.un_enc_user_id == user_id" ng-href="user_profile.php?id={{feed.inner_feed.user.id}}" class="black">&nbsp;
											{{feed.inner_feed.user.first_name}} {{feed.inner_feed.user.last_name}}'s discovery 
										</a>
									

										<a style="text-decoration:none;" ng-show="feed.inner_feed.un_enc_user_id != user_id" ng-href="user_profile_3.php?id={{feed.inner_feed.user.id}}" class="black">&nbsp;
											{{feed.inner_feed.user.first_name}} {{feed.inner_feed.user.last_name}}'s discovery  
										</a>
					...
					<span class="help-block " style="color:#CFCFCF; margin-left:10px;">{{feed.date_created}}</span>
				</h6>
		...
		<div class="row">
			...
			<div class="empty_right_side_frame" style="margin-top:10px;">
					...
					<div class="row" >
						<div class="col-md-10 col-lg-10 col-sm-10 col-xl-10 col-xs-10"></div>
						<div class="col-md-2 col-lg-2 col-sm-2 col-xl-2 col-xs-2">
							<div class="badge right_most_top_Outer_badge" style="margin-top:0px; margin-left:10px;" >
								 <div class="icon icon-shop3 " style="font-size:20px;margin-top:65%;"></div> 
							</div>
						</div>
					</div>
		<!-- End of row with the right most three dots -->
		...
		<div class="row" style="margin-top:5px;margin-bottom:10px;margin-left:10px;">
			...
			<div class="col-md-10 col-lg-10 col-sm-10 col-xl-10 col-xs-10 profile_name_section_left">
				...
				<h6>					
					<span class="profile_name" style="margin-left:-20px;">
										<a style="text-decoration:none;" ng-show="feed.inner_feed.user.id == user_id" ng-href="user_profile.php?id={{feed.inner_feed.user.id}}" class="black">&nbsp;
											{{feed.inner_feed.user.first_name}} {{feed.inner_feed.user.last_name}}
										</a>
									

										<a style="text-decoration:none;" ng-show="feed.inner_feed.user.id != user_id" ng-href="user_profile_3.php?id={{feed.inner_feed.user.id}}" class="black">&nbsp;
											{{feed.inner_feed.user.first_name}} {{feed.inner_feed.user.last_name}} 
										</a> <span style="font-weight:lighter">discovered</span> 


										<B ng-show="feed.inner_feed.business.owner_id==feed.user_id"><a ng-href="business_page_owners_view.php?current_business_id={{feed.inner_feed.business.id}}" style="text-decoration:none;" class="black">{{feed.inner_feed.business.name}}</a></B>	


										<B ng-show="feed.inner_feed.business.owner_id!==feed.user_id"><a href="business_page_3.php?current_business_id={{feed.inner_feed.business.id}}" style="text-decoration:none;" class="black">{{feed.inner_feed.business.name}}</a></B>
			...
			<div class="col-md-12 col-lg-12 col-sm-12 col-xl-12 col-xs-12 ">
				 ...
				 <img ng-src="{{BaseImageURL+feed.inner_feed.business.banner}}" class="img-responsive"  style="width:440px;height:250px"  alt="Generic placeholder thumbnail">
				
				<a href="business_page_3.php?current_business_id={{feed.inner_feed.business.id}}" ng-show="feed.inner_feed.business.owner_id!=feed.user_id" class="redbright" style="margin-bottom:1px;margin-top:10px;">{{feed.inner_feed.business.name}}</a>

				<a href="business_page_owners_view.php?current_business_id={{feed.inner_feed.business.id}}" ng-show="feed.inner_feed.business.owner_id==feed.user_id" class="redbright" style="margin-bottom:1px;margin-top:10px;">{{feed.inner_feed.business.name}}</a>
				
				<div class="profile_updte_time" style="margin-bottom:5px;">{{feed.inner_feed.business.address}}</div>
								
								<table>
								<tr>
									<td style="width:500px;">
									<div ng-show="feed.inner_feed.good>-1 && feed.inner_feed.cost>-1 ">
					...
					<td>	
							...
							<div ng-show="feed.inner_feed.business.followedByUser==0" ng-click="followInnerItem('business',sender_id,feed.inner_feed.business.id,feed.id)" >
							...
							<div ng-show="feed.inner_feed.business.followedByUser==1" ng-click="unfollowInnerItem('business',sender_id,feed.inner_feed.business.id,feed.id)" >
		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12 col-xl-12 col-xs-12">	
				...
				<h6 >
								...
								<div id="sadcommentors{{feed.id}}" style="margin-bottom:5px;">
