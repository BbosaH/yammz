...
<div ng-repeat="businessModel in businessModels | limitTo:5"  id="buz{{businessModel.id}}">
		<div class="row"  >
			...
			<div class="col-lg-9 col-sm-9 col-md-9 col-xs-9">
				 <div class="caption" style="margin-top:-4px;">
					...
					<?php require_once("user_profile/followdialog.php") ?>
						<span class="pull-right" style="padding-top:0px;" ng-click="followItem('business',user_id,businessModel.id)"  data-toggle="modal" data-target="#follow_example" >
					...
					<h6 style="width:160px;white-space: nowrap; overflow: hidden;  text-overflow:ellipsis; margin-top:-10px;">{{businessModel.address}}</h6>
