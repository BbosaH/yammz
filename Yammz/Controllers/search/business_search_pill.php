<table style=" margin-left:10px;" ng-cloak>
	<tr>
		...
		<td style="padding-left:10px; margin-top:5px; margin-bottom:5px;" >
			...
			<a class="redbright" ng-if="business.owner_id==user_id" ng-href="{{BaseURL}}business_page_owners_view.php?current_business_id={{business.id}}" style="padding-top:15px; text-decoration:none;padding-left:5px;" ng-bind="business.name">
				
			</a>
			<a class="redbright" ng-if="business.owner_id!=user_id" ng-href="{{BaseURL}}business_page_3.php?current_business_id={{business.id}}" style="padding-top:15px; text-decoration:none;padding-left:5px;" ng-bind="business.name">
