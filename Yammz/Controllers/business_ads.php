	...
	<input type="hidden" ng-model="country_id"  ng-init="country_id='<?php echo $_SESSION['SESS_COUNTRY_ID']; ?>'" />
		<div class="panel panel-default" style="border:none; border-radius:0px">
			<div class="panel-body">
					...
					<!-- {{side_addModels[0]}} -->
						<a class="badblack" style="text-decoration:none" href="{{BaseURL}}business_page_3.php?current_business_id={{side_addModels[0].enc_business_id}}">{{side_addModels[0].business_name}}</a>
					...
					<div class="col-lg-2 col-sm-2 col-md-2 col-xs-2 " style="padding-left:5px;" >
						<span class="pull-right" style="padding-top:10px;margin-right:6px;">
						  &nbsp; <span style="font-size:16px; color:#ECCB37" class="icon icon-add182" ng-click="followItem('business',user_id,side_addModels[0].business_id)"></span>
		...
		<div class="panel panel-default" style="border:none; border-radius:0px">
			<div class="panel-body">
					...
					<div class="col-lg-8 col-sm-8 col-md-8 col-xs-8 ">
							<a class="badblack" style="text-decoration:none" href="{{BaseURL}}business_page_3.php?current_business_id={{side_addModels[1].enc_business_id}}">{{side_addModels[1].business_name}}</a>
						<p class="grey">Sponsored</p>
					</div>
					<div class="col-lg-2 col-sm-2 col-md-2 col-xs-2 " style="padding-left:5px;" >
						<span class="pull-right" style="padding-top:10px;margin-right:6px;">
						  &nbsp; <span style="font-size:16px; color:#ECCB37" class="icon icon-add182" ng-click="followItem('business',user_id,side_addModels[1].business_id)"></span>
						  <span style="font-size:10;color:#7D7D7D;"><br/>Follow</span>
						</span>
					</div>
