...
<div class="container2" ng-controller="SearchCtrl">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar"  >
      ...
      <ul class="nav navbar-nav" style="margin-left:0%;" ng-controller="IndexCtrl">
        ...
        <form role="search" class="navbar-form navbar-left" method="post" action="search.php" >
           ...
           <li class="">
              ...
              <input type="text"  ng-model="searchInputValue" name="search" id="searchinput" class="form-control pull-left noborderStyle" style="border-radius:0;" >
                ...
                <button  class="btn" type="submit" name="searching" ng-click="storeLoggedWord(searchInputValue)"  style="border-radius:0;" >
