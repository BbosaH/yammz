...
/***
*
*Created new page displaying Suggested businesses to follow before login
*/
error_reporting(0);
		...
		<div class="row"  >
			...
			<div class="col-lg-9 col-sm-9 col-md-9 col-xs-9">
				 <div class="caption" style="margin-top:-4px;">
					<p ><div class="redbright" style="width:160px;white-space: nowrap; overflow: hidden;  text-overflow:ellipsis;" ><a class="redbright" style="text-decoration:none" href="{{BaseURL}}business_page_free.php?current_business_id={{businessModel.id}}">{{businessModel.name}}</a></div>
					<?php require_once("user_profile/followdialog.php") ?>
						<span class="pull-right" style="padding-top:0px;" onclick="showModal()"  data-toggle="modal" data-target="#follow_example" >
