...
<div class="navbar navbar-inverse navbar-fixed-top " style="background-color:#BD2532; height:63px;" >
<style>
.badge-background {
...
.form-control:focus{
  ...
  <div class="container">
		  ...
		  <table >
			  <tr >
				<td >
					...
					<span style=""><a class="btn" href="home2.php"  style=" noborderStyle;color:white; border:0px;padding-top:24px;"> <span style="font-size:32;">Yammzit<span>&nbsp; </span>
				</td >
		...
		<div class="collapse navbar-collapse" style="padding-top:10px; margin-right:5px;" ng-controller="SearchCtrl">
			  ...
			  <ul class="nav navbar-nav navbar-right" style="padding-top:20px;font-size:13">
				...
				<li><hr style="height:10px;width:1px;background-color:white;"></hr></li>
				<li class="dropdown">
				...
				<li><hr style="height:10px;width:0.5px;background-color:white;"></hr></li>
				<li class="dropdown" >
					...
					<ul class="dropdown-menu" style="font-size:11;size:20x20;">
						<li>
							<a href="user_profile.php?id=<?php require_once('classes/gstring_funcs.php');  echo gString($_SESSION['SESS_MEMBER_ID']); ?>"><i class="fa fa-fw fa-user"></i> My N Profile</a>
						</li>
						<li>
