...
/**
*Free Home_tab to show categories without login credentials
*added angular home module
*Controller FreeSearchCtrl that manages picking of categories
*
**/
 ...
 <html lang="en">
	...
	<body style="background-color:#E9EAEE" ng-app="home">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:#BD2532;color:#ffffff;border-color:#BD2532;color:#ffffff;">
			<div class="container2" ng-controller="FreeSearchCtrl">
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="myNavbar"  >
		      ...
		      <ul class="nav navbar-nav" style="margin-left:0%;">
		        <form role="search" class="navbar-form navbar-left" method="post" action="freesearch.php" >
		          
		           <li class="">
		              <div class="input-group" style="width:180%; margin-top:10px;">
									<input type="text"  name="search" id="searchinput" class="form-control pull-left noborderStyle" style="border-radius:0;" ng-model="searchInputValue" >

									  <span class="input-group-btn">
											 
										<button class="btn" type="submit" name="searching"  style="border-radius:0;" ng-click="storeWord(searchInputValue)">
		      ...
		      <ul class="nav navbar-nav navbar-right" style="margin-right:5px;margin-top:20px;margin-bottom:-25px;">
		        <li class="" >
		        <!-- style="color:#FF7F00;" -->
		          <a class="" href="signup.html" ><!-- <span class="glyphicon glyphicon-home white"></span> -->&nbsp;<span class="white">Sign up</span></a>
		        </li>
		        <li class="hidden-xs hidden-sm"><hr style="height:10px;width:1px;background-color:white;"></hr></li>
		        <li class="dropdown">
		          <a href="login.html" class="dropdown-toggle" data-toggle="dropdown" style="background-color:#BD2532;height:20px;"><!-- <i class="fa fa-envelope"></i> --><img src="images/icons/notification icon.png" width="13" height="14px">&nbsp;<span class="white">Login</span></a>
                                            ...
                                            <div class="panel-body" id="{{category.category_id}}"  stye="min-height: 500px;" >
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" >
                                                          ...
                                                          <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4" ng-repeat="sub_category in category.sub_categories">
                                                           <p style="margin-top:10px;"> <a hfref="#" style="text-decoration:none;cursor:pointer;" ng-click="getFreeBusinesses(sub_category.id)"   class="badblack">{{sub_category.name}}</a></p>
