					...
					<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
						<div class="panel panel-default" style="margin-top:30px;margin-right:0px;margin-left:3px;">
							<div class="panel-body">
								<span style="color:#BD2532;font-size:16px;"> <span style="font-weight:bold;">Successfully Reset</span></span>
								<hr style="margin-top:0px;margin-bottom:8px;height:1px;background-color:#E9EAEE;"></hr>
									<div style="height:20px;"></div>
									<h5 style="margin-left:15%;">Your password was successfully reset . Please proceed to login</h5>
