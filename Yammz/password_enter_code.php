					...
					<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
						<div class="panel panel-default" style="margin-top:30px;margin-right:0px;margin-left:3px;">
							<div class="panel-body">
								<span style="color:#BD2532;font-size:16px;"> <span style="font-weight:bold;">Enter Code</span></span>
								<hr style="margin-top:0px;margin-bottom:8px;height:1px;background-color:#E9EAEE;"></hr>
							
									<span style="font-size:12px;margin-top:-20px;">A Message has been sent to your Phone number with a code. Enter the code to reset your password.<span>
										<form style="margin-top:10px;">
											<div class="row">
												<div class="col-lg-2 col-xlg-2 col-md-2 col-sm-3 col-xsm-2">
													
													<textarea class="form-control" rows="3" id="address" name="address" style="background-color:#E9EAEE;resize:none;height:35px;width:160px;border:0px;margin-right:5px;" placeholder=""></textarea> 
						 
												</div>
												<div class="col-lg-4 col-xlg-4 col-md-4 col-sm-6 col-xsm-12">
													<span style="font-weight:bold;margin-left:20px;">We sent your code to</span><br/>
													<span style="margin-left:20px;">+2567759938</span>
												</div>
