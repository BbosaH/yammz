	...
	<div class="container" style="padding-left:30px;padding-right:30px;"  ng-controller="EditFullBusinessCtrl">
		<input type="hidden" ng-model="business_id" ng-init="business_id='<?php echo $_GET['current_business_id']; ?>'">
			...
			<div class="panel panel-default">
				<form ng-submit="postEditBusiness()"  style="padding-left:30px; padding-right:100px;" enctype="multipart/form-data" > 
					
					<h4> <label for="name" class="" style="color:#BD2532;"><B>Edit Business info</B></label> </h4>
					...
					<div class="form-group"> 
						 ...
						 <input type="text" class="form-control" style="width:500px;border-radius:4px;background-color:#EBEAEF;border:0px;" id="name" name="email" ng-model="businessobject.business_email" ng-init="businessobject.business_email='<?php if($business['email']=="_______________________________"){echo "";}else{echo $business['email'];}  ?>'" placeholder="" required="required">
							
					</div>
					<div class="form-group"> 
						 <h6> <label for="name" class="">Official Website for the business</label> </h6>
						 <input type="text" class="form-control"  style="width:500px;border-radius:4px;background-color:#EBEAEF;border:0px;" id="name" name="postion" ng-model="businessobject.business_website" ng-init="businessobject.business_website='<?php if($business['website']=="_______________________________"){echo "";}else{echo $business['website'];}  ?>'" placeholder="" required="required">
					...
					<div class="row" >
						...
						<div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
							...
							<select class="form-control" ng-model="businessobject.country_id" ng-init="businessobject.country_id='<?php echo $country['id']; ?>'"  style="width:200px;border-radius:4px;background-color:#EBEAEF;border:0px;" ng-options=" country.id as country.name for country in countryModels" ng-change="updateCities(businessobject.country_id)">
							 			<option  value="{{businessobject.country_id}}"></option>
					...
					<div class="row">
						...
						<div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
							...
							<input type="text" class="form-control" style="width:200px;border-radius:4px;background-color:#EBEAEF;border:0px;" id="name" name="phone_2" ng-model="businessobject.phone_2" ng-init="businessobject.phone_1='<?php echo $business['phone_2']; ?>'" placeholder="" />
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
					...
					<div style="height:30px;"></div>
					 ...
					 <B><hr style="height:7px; background-color:#E9EAEE;"></hr></B>
			 			...
			 			<h6> <label for="name">Address</label> </h6>
						  <input type="text" class="form-control" style=" max-width:600px;height:110px;background-color:#EBEAEF;" id="name" name="description" placeholder="" ng-model="businessobject.address" ng-init="businessobject.address='<?php echo $business['address']; ?>'"  minlength=4 ng-maxlength=50 required="required" > 
						 <div style="height:30px;"></div>

						 <h6> <label for="name">Business Description</label> </h6>
						  <input type="text" class="form-control" style=" max-width:600px;height:140px;background-color:#EBEAEF;" id="edit_business_description" name="description" placeholder="" ng-model="businessobject.business_description" ng-init="businessobject.business_description='<?php echo $business['description']; ?>'" minlength=4 ng-maxlength=50 required="required"> 
						 <div style="height:30px;"></div>
					 ...
					 <B><hr style="height:7px; background-color:#E9EAEE;"></hr></B>
						 ...
						 <B><hr style="height:7px; background-color:#E9EAEE;"></hr></B>
				 		 ...
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		...
				 		 		<input type="text" name="facebook" ng-model="businessobject.facebook_link" ng-init="businessobject.facebook_link='<?php echo $user_claim['facebook_link']; ?>'" value="<?php echo $user_claim['facebook_link']; ?>" class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		<p class="col-xs-2 col-sm-6 col-md-2 col-lg-2 col-xl-2 social_link_text">Twitter</p>
				 		 		<input type="text" name="twitter" ng-model="businessobject.twitter_link" ng-init="businessobject.twitter_link='<?php echo $user_claim['twitter_link']; ?>'" value="<?php echo $user_claim['twitter_link']; ?>" class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
				 		 ...
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		...
				 		 		<input type="text" name="youtube" ng-model="businessobject.youtube_link" ng-init="businessobject.youtube_link='<?php echo $user_claim['youtube_link']; ?>'" value="<?php echo $user_claim['youtube_link']; ?>" class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		<p class="col-xs-2 col-sm-6 col-md-2 col-lg-2 col-xl-2 social_link_text">instagram</p>
				 		 		<input type="text" name="instagram" ng-model="businessobject.instagram_link"  ng-init="businessobject.instagram_link='<?php echo $user_claim['instagram_link']; ?>'" value="<?php echo $user_claim['instagram_link']; ?>" class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
						...
						<br/>
						 <div class="fileUpload btn btn-danger" style="border-radius: 5px;margin-left:0px;  background-color:#BD2532;">
		    				<span>Add photo</span>
			    			<input id="input_banner" type="file"  name="CoverPhoto" class="upload" file-model="my_cover_photo"   />
						</div>
							...
							<table>
								<tr>
									...
									<td>
						    			...
						    			<input id="input_logo" type="file"  name="LogoPhoto" class="upload" file-model="my_logo"   />
										</div>
