...
function fill_rating_post($feed)
{
...
//var_dump($feed);
	    ...
	    $firstChar =$feed["user"]["first_name"][0];
						...
						<tr>
							<td style="vertical-align:top;" width="10px;">
								...
								<div class="outer_profile_letter">
								      <div class="outer_profile_letter_center">{$firstChar}</div>					
							    </div>	
							</td>
							<td>
								<span>
									...
									<table>
										<tr>
											<td style="width:110px;">
												<a href="javascript:void();"  style="font-size:9px; background-color:white;text-decoration:none;" id=""><span class="icon icon-like85 redbright " style="font-size:16px;"> &nbsp;<span class="simplegrey" style="font-size:12;">0 </span>&nbsp;<span style="font-size:12;" class="simplegrey">
													Likes
												</span></a>
											</td>
