...
function fill_only_photo_post($feed)
{
...
//var_dump($feed);
		...
		$photo=BaseImageURL.$feed['details'];
							...
							<td>
								<span>
									<h6>
										...
										added photo to <B><a id="biz"  style="text-decoration:none;" class="black" onclick="toBusiness({$feed['user']["id"]} ,{$feed['business']["id"]})">{$feed["business"]["name"]}</a></B>
