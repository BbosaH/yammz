...
function fill_random_biz($business)
{
	session_start();
	...
	$prev_id=26;
	$next_id=27;
	$prev_button='<a href="#" data-id="'.$prev_id.'" class="get_pic"><img src="images/icons/arrow.png" style="width:6px;height:12px;" border="0" onclick="pickRandomBiz()" /></a>';
	$next_button ='<a href="#" data-id="'.$next_id.'" class="get_pic"><img src="images/icons/arrow 2.png" style="width:6px;height:12px;" border="0" onclick="pickRandomBiz()" /></a>';
	...
	{
		$business['logo']=BaseImageURL
		.$business['logo'];
	}
	//$business['name']=substr($business['name'],25);
	//$business['address']=substr($business['address'],10);
	$date_created = time();

	$addPhotourl =BaseImageURL."uploads/capture.png";
	$business_url =BaseURL."business_page_3.php?current_business_id=".$business['id'];
