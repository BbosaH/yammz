	...
	<body ng-app="starter">
		...
		<div class="navbar navbar-inverse navbar-fixed-top" style="background-color:#BD2532" >
		  	<div class="" style="margin-left: 40px;margin-right: 80px;">
			    ...
			    <div class="collapse navbar-collapse" style="padding-top:5px; margin-right:0px;" ng-controller="AuthController">
						
						<ul class="nav navbar-nav navbar-right" style="padding-top:10px;padding-right:9px;">
							<form class="navbar-form" role="search" enctype="multipart/form-data">
									...
									<div class="row" style="margin-right: -58px;">
										...
										<div class="col-lg-5 col-xlg-5 col-sm-12 col-md-5 col-xs-12" style="margin-right: -15px;">
											...
											<input type="text" name="username" class="form-control pull-right noborderStyle" style="border-radius:0;height:35px;width: 100%;" placeholder="" ng-model="loginModel.username" >
											<br>

											<label style="margin-top: 5px;margin-bottom: 0px; margin-left: -35px;color: #FFFFFF;"> <?php
										...
										<div class="col-lg-5 col-sm-12 col-xlg-5 col-md-5 col-xs-12">
											...
											<input type="password" name="password" class="form-control pull-right noborderStyle" style="border-radius:0;height:35px;width: 100%;" placeholder="" ng-model="loginModel.password">
										...
										<div class="col-lg-2 col-xlg-2 col-sm-12 col-md-2 col-xs-12" style="margin-left: -40px;">
											<label></label><br><br>
											<button class="btn btn-small noborderStyle pull-right" type="submit" style="height:35px;min-height:27px;min-width:60px;background-color:white;text-align: center;color:#000000;font-weight:bold;padding-top:6px;" value="Login" ng-click="login()">
												LOG IN
											</button>
										</div>
			...
			<form name="signUpForm" ng-submit="postData()">
				...
				<div class="row" style="margin-left: 25px;">
					...
					<div class="col-md-3 col-lg-3 col-xl-3">
						...
						<input class="form-control" type="text" name="" style="width: 100%;background-color: #EBE6E3;border-color: #EBE6E3;border-radius: 8px;margin-bottom: 23px;" id="phone" name="phone" ng-minlength=4 ng-maxlength=15 placeholder=" * phonenumber" ng-model="signobject.phone_number" required>					
					</div>
				</div>
				...
				<div class="row" style="margin-left: 25px;">
					...
					<div class="col-md-3 col-lg-3 col-xl-3">
						...
						<span style="margin-top:20px; "  ng-show='signUpForm.confirmpass.$error.pwmatch'>
