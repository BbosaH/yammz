		...
		<input type="hidden" ng-model="business_id" ng-init="business_id='<?php echo gStringId($_GET['current_business_id']); ?>'">
			...
			<div class="panel panel-default">
				<form  style="padding-left:30px; padding-right:100px;" enctype="multipart/form-data" > 
					...
					<div class="form-group"> 
						 <h6> <label for="name" class="">Your Current postion at the company / business</label> </h6>
						 <input type="text" class="form-control"  style="width:500px;border-radius:4px;background-color:#EBEAEF;border:0px;" id="name" name="position" ng-model="FullBusiness.business_claim.position" placeholder="" required="required">
							
					</div>

					<div class="form-group"> 
						 <h6> <label for="name" class="">Official Email for the business</label> </h6>
						 <input type="text" class="form-control" style="width:500px;border-radius:4px;background-color:#EBEAEF;border:0px;" id="name" name="email" ng-model="FullBusiness.business_claim.email"  placeholder="">
					...
					<div class="row">
						<div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
							...
							<input type="text" class="form-control" style="width:200px;border-radius:4px;background-color:#EBEAEF;border:0px;" id="name" name="phone_1" ng-model="FullBusiness.business_claim.phone_1"  placeholder="" >
						</div>
						<div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
							<span class="" style="font-size:12px;font-weight:bold;">Other Business No</span>
							<input type="text" class="form-control" style="width:200px;border-radius:4px;background-color:#EBEAEF;border:0px;" id="name" name="phone_2" ng-model="FullBusiness.business_claim.phone_2"  placeholder="" />
						</div>
					</div>
					<div style="height:10px;"></div>
					 ...
					 <B><hr style="height:7px; background-color:#E9EAEE;"></hr></B>
			 			...
			 			<h6> <label for="name">Address</label> </h6>
						  <textarea  class="form-control" style=" max-width:600px;height:110px;background-color:#EBEAEF;" id="name" name="description" placeholder="" ng-model="FullBusiness.business_claim.address"   minlength=4 ng-maxlength=50  > 
						  </textarea>
						 <div style="height:30px;"></div>

						 <h6> <label for="name">Business Description</label> </h6>
						  <textarea type="text" class="form-control" style=" max-width:600px;height:140px;background-color:#EBEAEF;" id="edit_business_description" name="description" placeholder="" ng-model="FullBusiness.business_claim.description"  minlength=4 ng-maxlength=50 > </textarea>
						...
						<div ng-include="'edit_working_hours.html'"></div>
						...
						<br/><br/></br/>
						 ...
						 <!--      removed facebook links -->
				 		 ...
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		...
				 		 		<input type="text" name="facebook" ng-model="FullBusiness.business_claim.facebook_link"  class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		<p class="col-xs-2 col-sm-6 col-md-2 col-lg-2 col-xl-2 social_link_text">Twitter</p>
				 		 		<input type="text" name="twitter" ng-model="FullBusiness.business_claim.twitter_link" class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
				 		 ...
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		...
				 		 		<input type="text" name="youtube" ng-model="FullBusiness.business_claim.youtube_link" class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
				 		 <div class="row rowbottom20">
				 		 	<div col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
				 		 		<p class="col-xs-2 col-sm-6 col-md-2 col-lg-2 col-xl-2 social_link_text">instagram</p>
				 		 		<input type="text" name="instagram" ng-model="FullBusiness.business_claim.instagram_link" class="col-xs-3 social_links_input" >
				 		 	</div>
				 		 </div>
						 ...
						 <img ng-src="{{BaseImageURL+FullBusiness.business_claim.banner_web}}" style="width:85%;max-height:300px" />
						...
						<br/>
						 ...
						 <B><hr style="height:7px; background-color:#E9EAEE;"></hr></B>
							...
							<table>
								<tr>
									<td>
										<img class="img-circle" ng-src="{{BaseImageURL+FullBusiness.business_claim.logo_web}}" width="150px" height="150px;" />
									</td>
									<td>
						 ...
						 <p><B>Other Details</B></p>
							...
							<div ng-include="'business_Services.php'" ></div>
						 	...
						 	<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
						 		<div class="row">
						 			<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9">
						 				<button type="submit" ng-disabled="isEditing==1" ng-click="postEditBusiness()" class="btn btn-default " style="height:45px;min-width:140px;margin-left: -35%; border-radius:10; background-color:#BD2532;font-size:18; font-weight:bold; color:#EED1D5;">Save</button>
						 			</div>
						 		...
						 		<div class="row" ng-show="isEditing==1">
