					...
					<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12"  >
						<div class="panel panel-default" style="margin-top:30px;margin-right:0px;margin-left:3px;">
							<div class="panel-body">
								<span style="color:#BD2532;font-size:16px;">Your username is <span style="font-weight:bold;"><?php
								$res = $connn->getAll("SELECT email FROM user WHERE id ='".$_GET['username']."'");
											...
											<table>	
												<tr>
													...
													<td>
														...
														<label style="margin-right:125px;font-size:16px;color:#BD2532;" class="pull-right">Please set your password</label>
														<br/>
														<br/>
												...
												<tr>
													<td width="150px">
														<span style="margin-right:20px;font-size:12px;" class="pull-right">Password<span>
													</td>
													<td>
														<input type="password" class="form-control"style="width:300px; border-color:#868686;background-color:#E9EAEE;border:0px; border-radius:0;" id="newpass" > 
												...
												<tr>
													<td width="150px">
														<span style="margin-right:20px;font-size:12px;" class="pull-right">Confirm password<span>												
													</td>
													<td>
														<input type="password" class="form-control"style="width:300px; border-color:#868686; border-radius:0;background-color:#E9EAEE;border:0px;" id="confirmnewpass" > 
							...
							<div class="panel-footer">
								<table >							
									<tr>
										...
										<td>
											<button  type="button" name="add_business" class="btn btn-default" style="height:22px;font-size:14px;padding-top:0px; width:50px; background-color:#BD2532; font-weight:bold;border-radius:6px;padding-left:7px;color:#EED1D5;margin-left:730px;" onclick="pickCre('<?php echo $_GET['username']; echo "'";?>)">Save</button>
											<B>&nbsp;&nbsp;&nbsp;&nbsp;Cancel</B>
										</td>
