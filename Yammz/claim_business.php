					 ...
					 <B><hr style="height:7px; background-color:#E9EAEE;"></hr></B>
						...
						<br/>
						 ...
						 <p><B>Other Details</B></p>
							...
							<div ng-include="'row_business_Services.php'" ></div>
						 	...
						 	<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
						 		<div class="row">
						 			<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xl-9">
						 				<button type="submit" ng-disabled="isClaiming==1" ng-click="postClaimBusiness()" class="btn btn-default " style="height:45px;min-width:140px;margin-left: -35%; border-radius:10; background-color:#BD2532;font-size:18; font-weight:bold; color:#EED1D5;">Save Claim</button>
						 			</div>
						 		...
						 		<div class="row" ng-show="isClaiming==1">
