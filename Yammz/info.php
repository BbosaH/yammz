...
<html lang="en">
	...
	<body style="background-color:#ffffff;" ng-app="starter">
		  ...
		  <div class="container">
			    ...
			    <div class="collapse navbar-collapse" style="padding-top:15px; margin-right:16px;">
						...
						<ul class="nav navbar-nav navbar-right" style="padding-top:10px;padding-right:9px;">
							<form class="navbar-form navbar-left" action="#"  role="search" method="post" style="margin-right:-70px;">
								<div class="input-group" >
									...
									<div class="row">
										...
										<div class="col-lg-2 col-xlg-2 col-sm-2 col-md-2 col-xs-2">
											...
											<img src="<?php echo $photo ?>" style="width:30px; height:30px; border-radius:50%; background-color:#f2f2f2" class="img-circle">
							...
							<label style="margin-top: 18px; margin-left: 0px;  "><a href="<?php echo BaseURL; ?>forgot_password.php" style="color: white; padding-top: 100px; text-decoration: none; font-weight: lighter;"><?php echo "$name";  ?></a></label>
						</u>
			...
			<div class="row">
				<div class="container">
					...
					<div class="row" style="margin-bottom:10px;">
						<div class="col-lg-12 col-xlg-12 col-sm-12  col-md-12 col-xs-12 ">
							<h4 style="text-align: center;font-size:30px;">Yammzit website is currenty not available in your country.</h4>
						<h3 style="text-align: center;font-weight:bold;margin-bottom:20px;margin-left:-5px;font-size:30;color:#5A5A5A;">Currently available only on the App</h3>

						</div>
					</div>

					<div class="col-lg-3 col-xlg-3 hidden-xs col-md-3 hidden-sm" >				
					...
					<div class="col-lg-6 col-xlg-6 col-sm-12  col-md-6 col-xs-12 ">			
						...
						<div class="row" style="margin-bottom:30px;">
							<div class="col-lg-6 col-xlg-6 col-sm-12  col-md-6 col-xs-12 ">
								<a href="#">
									<img src="../admin/Theme/uploads/Googleplayyyy.png" style="width:100%;height:70px;margin-bottom:5px;">
								</a>
							</div>
							<div class="col-lg-6 col-xlg-6 col-sm-12  col-md-6 col-xs-12 ">
								<a href="../admin/Theme/apk/yammzit.apk">
									<img src="../admin/Theme/uploads/Download APK.png" style="width:100%;height:70px;">
								</a>
							</div>
						</div>

						<img src="../admin/Theme/uploads/ad_defaut_1.png" style="width:100%;">

						
					</div>

					<div class="col-lg-3 col-xlg-3 hidden-sm col-md-3 hidden-xs" >
		...
		<div>
			<img src="../admin/Theme/uploads/city4.0.png" style="width:100%;margin-top:-30px;">
		</div>
