					...
					<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
						<div class="panel panel-default" style="margin-top:30px;margin-right:0px;margin-left:3px;">
							<div class="panel-body">
								<span style="color:#BD2532;font-size:16px;"> <span style="font-weight:bold;">Password Link Sent</span></span>
								<hr style="margin-top:0px;margin-bottom:8px;height:1px;background-color:#E9EAEE;"></hr>
									<div style="height:20px;"></div>
									<h5 style="margin-left:25%;">Please check your email address for <label>"password reset" link</label></h5>
									<!-- <h6 style="margin-left:26%;"> </h6> -->
