...
<section id="container" >
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        ?>
          <h3><i class="fa fa-angle-right"></i> Countries and cities</h3>
          <?php
              $msga = "";
          ...
          <div class="row mt">
            ...
            <div class="col-lg-6">
              <div class="col-lg-12 col-md-12 col-sm-12 mb noSidePadding" >
                <div class="form-panel padding yammzitPanel">
                  <h4 class="mb noMarginBottom">
                    <i class="fa fa-angle-right"></i> List of countries
                  </h4>
                  <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                            ...
                            ?>
                                  <tr>
                                    <td><img src="<?php echo $value["flag"];  ?>" class="tableFlag" /></td>
                                    <td><?php echo $value["name"];  ?> <br/> <?php echo $value["code"];  ?></td>
                                    <td><a href="countries.php?c=<?php echo $value["id"];  ?>"><i class="fa fa-eye"></i> View</a></td>
                                  </tr>
                            <?php
                                }
                              ?>
