                           ...
                           <div class="col-xs-6 col-md-6" >
                               <div class="panel panel-default left_panel">
                                <div class="panel-body" >
                                  ...
                                  <p style="margin-bottom:1px;"><span class="left_side_ads_values">400</span> <span style="font-size:12px;">Ads</span></p>
                           ...
                           <div class="col-xs-6 col-md-6" style="margin-left:-1%;width:51%;">
                               <div class="panel panel-default left_panel">
                                <div class="panel-body" >
                                  ...
                                  <p style="margin-bottom:1px;"><span class="left_side_ads_values">300</span> <span style="font-size:12px;">Ads</span></p>
                         ...
                         <div class="panel-body" >
                          <div class="row">
                            <div class="col-xs-8 col-md-8" style="">
                               ...
                               <p style="color:#77AF80;margin-bottom:3px;"><span class="left_side_ads_values">700</span> <span style="font-size:12px;">Ads</span></p>
                            </div>
