				  ...
				  <div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 " style="margin-bottom:20px;" >
						 ...
						 <span class="pull-right">
						    <form action="add_cat_or_sub_category.php" method="POST">
								<button class="btn" name="add_city_country" style="border:none;background-color:#BE2633;color:#ffffff;font-size:12px;">
								 <!-- [Wilson] <i class="icon icon-add182" ></i> --><span style="font-size:16px;"> +</span> &nbsp;Category & sub..
								</button>
						    </form>
						 </span>
					</div>
					...
					$number +=1;
                            ?>
                                  <tr>
                                    ...
                                    <td><?php echo $sub_category_no; ?></td>
									<td><?php echo "active";  ?> </td>
                                    <td><a style="color:#000;" href="category_sub_edit.php?ctgy=<?php echo $value["id"] ; ?>">View</a></td>
