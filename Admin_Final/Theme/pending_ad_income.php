...
<section id="container" >
                            ...
                            <div class="panel panel-default goal_panel2">
                               <div class="panel-body" >                                 
                                  <div class="row botttom20">
                                    ...
                                    <div class="col-xs-6 col-md-6 colorwhite"><div class="pull-right"><u style="cursor: pointer;" onclick="GoDetails('finance23.php','Pending')">View More</u></div>
                                    </div>
                                  </div>
                                  <table class="table accountTable" cellpadding="10" >
                                     <tr>
                           ...
                           <div class="panel panel-default goal_panel2">
                               <div class="panel-body" >                                 
                                  <div class="row botttom20">
                                    ...
                                    <div class="col-xs-6 col-md-6 colorwhite"><div class="pull-right"><u style="cursor: pointer;" onclick="GoDetails('finance24.php','Pending')">View More</u></div>
                                    </div>
                                  </div>
                                  <table class="table accountTable" cellpadding="10" >
                                     <tr>
                          ...
                          <div class="panel panel-default goal_panel2">
                               <div class="panel-body" >
                                 ...
                                 <div class="row botttom20">
                                    ...
                                    <div class="col-xs-6 col-md-6 colorwhite"><div class="pull-right"><u style="cursor: pointer;" onclick="GoDetails('finance25.php','Pending')">View More</u></div>
                                    </div>
                                  </div>
                                  <table class="table accountTable" cellpadding="10" >
                                     <tr>
    ...
    <!--***************end content**************-->
      <script type="text/javascript">
        window.onload=finance2RenderGraphs("pending");
      </script>
  <?php
      include("footing.php");
    ?>
