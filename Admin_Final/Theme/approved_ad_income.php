...
<section id="container" >
                            ...
                            <div class="panel panel-default set_goal_upper_section">
                              <div class="panel-body" >
                                 <div class="row" style="margin-bottom:20px;">
                                    ...
                                    <div class="col-xs-6 col-md-6 colorwhite"><div class="pull-right"><u style="cursor: pointer;" onclick="GoDetails('finance21.php','Approved')">View More</u></div>
                                    </div>
                                  </div>
                                  <?php
                            ...
                            <div class="panel panel-default goal_panel2">
                               <div class="panel-body" >                                 
                                  <div class="row botttom20">
                                    ...
                                    <div class="col-xs-6 col-md-6 colorwhite"><div class="pull-right"><u style="cursor: pointer;" onclick="GoDetails('finance23.php','Approved')">View More</u></div>
                                    </div>
                                  </div>
                                  <table class="table accountTable" cellpadding="10" >
                                     <tr>
                           ...
                           <div class="panel panel-default goal_panel2">
                               <div class="panel-body" >                                 
                                  <div class="row botttom20">
                                    ...
                                    <div class="col-xs-6 col-md-6 colorwhite"><div class="pull-right"><u style="cursor: pointer;" onclick="GoDetails('finance24.php','Approved')">View More</u></div>
                                    </div>
                                  </div>
                                  <table class="table accountTable" cellpadding="10" >
                                     <tr>
                          ...
                          <div class="panel panel-default goal_panel2">
                               <div class="panel-body" >
                                 ...
                                 <div class="row botttom20">
                                    ...
                                    <div class="col-xs-6 col-md-6 colorwhite"><div class="pull-right"><u style="cursor: pointer;" onclick="GoDetails('finance25.php','Approved')">View More</u></div>
                                    </div>
                                  </div>
                                  <table class="table accountTable" cellpadding="10" >
                                     <tr>
    ...
    <!--***************end content**************-->
      <script type="text/javascript">
        window.onload=finance2RenderGraphs("Approved");
      </script>
  <?php
      include("footing.php");
    ?>
