...
<section id="container" >
      ...
      <section id="main-content" style="background-color:#EAE9EF;">
      	<section class="wrapper" style="margin-top:80px;">     	
      		 	...
      		 	<?php if(strlen($_GET['k']) >0){
      		 			$conn->success_alert("Business successfully Deactivated");
      		 		} 
  		 		?>
              					...
              					<table class="table table-bordered table-hover" id="dataTables-example" cellspacing="30" style="cursor:pointer;">
				                    ...
				                    <tbody>
				                    	<?php
					                          ...
					                          $res = $connn->getApprovedClaimedBusinesses();
					                    ...
					                    ?>
					                    		 <tr>
					                              ...
					                              <td><a  href='claimed_business_detail.php?k=200&bus_id=<?php echo $value["id"];?>'  style="color:#5A5A5A;"   >View</a>
