    ...
    <div class="form-group input-group">
        <input type="text" class="form-control searchIcon">
        <span class="input-group-btn">
            <button disabled class="btn btn-default"  type="button"><i class="fa fa-search"></i>
            </button>
        </span>
    </div>

    <ul class="scroll300 strimicons iconsDiv showScroll" >
